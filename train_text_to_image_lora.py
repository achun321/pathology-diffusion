...
def main():
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet):
                ...
                # encoder_hidden_states = adaptation_layer(encoder_hidden_states)
    ...
    if accelerator.is_main_process:
        ...
        unet.save_attn_procs(args.output_dir, weight_name="plip_custom_diffusion_weights.bin")
        text_encoder.save_pretrained(args.output_dir, subfolder="text_encoder")
    ...
    pipeline = StableDiffusionPipeline.from_pretrained(
        args.pretrained_model_name_or_path, text_encoder=text_encoder, revision=args.revision, torch_dtype=weight_dtype
    )
    pipeline = pipeline.to(accelerator.device)
